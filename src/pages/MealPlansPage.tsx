...
const plans: Array<{ code: SubscriptionPlanCode; meals: number; name: string; bestFor: string; benefits: string[]; popular?: boolean }> = [
  { code: 'weekly_7', meals: 7, name: '7-Meal Routine', bestFor: 'Trying a predictable weekly routine', benefits: ['Choose breakfast, lunch or dinner', 'Serviceability checked before payment', 'Final price confirmed by Operations'] },
  ...
  return <div className="min-h-[80vh] bg-[#FAF8F5] py-8 sm:py-14">
    <div className="mx-auto max-w-6xl space-y-8 px-4 sm:px-6">
      <section className="overflow-hidden rounded-3xl bg-[#0D6E44] p-6 text-white shadow-xl sm:p-10">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-6 text-emerald-100 sm:text-base">Select a meal count, service and start date. Operations checks your address, kitchen capacity and final amount before activation.</p>
