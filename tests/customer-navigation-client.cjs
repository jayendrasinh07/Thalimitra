...
assert.match(nativeNavigation, /const showLocation = activeTab === 'home' \|\| activeTab === 'todays_menu'/);
...
assert.match(nativeNavigation, /getAddressPrimaryLine\(confirmedAddress\)/);
